...
//
class TaskViewController: UIViewController, UIImagePickerControllerDelegate, SelectedImageDelegate {
    ...
    override func prepareForSegue(segue: UIStoryboardSegue, sender: AnyObject?) {
        if segue.identifier == "selectImageSegue"{
            if let vc = segue.destinationViewController as? ImagePickerViewController{
                vc.delegate = self
            }
        }
    }
